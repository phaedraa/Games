...
class Memory:
    ...
    they will return facing down. The objective of the game is 
    to achieve all pairs facing up in the lowest amount of turns.
    '''
    ...
    def num_cards_clicked(self):
        if self.card_1_idx != None and self.card_2_idx != None:
            return 2
        elif (self.card_1_idx != None) or (self.card_2_idx != None):
            return 1 
        else:
            return 0
